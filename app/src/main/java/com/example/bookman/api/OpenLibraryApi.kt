package com.example.bookman.api

import com.example.bookman.data.Book
import com.example.bookman.data.SearchResponse
...
interface OpenLibraryApi {
    ...
    fun getBook(@Query("bibkeys") searchQuery: String): retrofit2.Call<HashMap<String, Book>>
